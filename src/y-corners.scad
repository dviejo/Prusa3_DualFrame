...
module corner_base(){	
 translate([-9,-11,0])cube([18,22,47+extraHeight]);
}

module corner_holes(){
 translate([-11,-11,0+extraHeight]){
  // Bottom hole
...
module corner_fancy(){
 // Side corner cutouts
  ...
  translate([8,-9,0]) rotate([0,0,45-180]) translate([-15,0,-1]) cube([30,30,51]);
 // Top corner cutouts
  translate([7,0,49-2+extraHeight]) rotate([0,45,0]) translate([-15,-15,0]) cube([30,30,30]);
  translate([-7,0,49-2+extraHeight]) rotate([0,-45,0]) translate([-15,-15,0]) cube([30,30,30]);
  rotate([0,0,90]){
   translate([-9,0,49-2+extraHeight]) rotate([0,-45,0]) translate([-15,-15,0]) cube([30,30,30]);
  }
}
